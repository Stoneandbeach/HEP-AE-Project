...
grouped-encoding-31dim.ipynb notebook of this project, so a study of those is probably the way to build an understanding of what this
script produces. In essence, this script is only built to run AE training a number of times with different input parameters.
